  ...
  es: {
    ...
    products: {
      ...
      items: {
        ...
        driedFish: {
          name: 'Bacalao seco',
          description: 'Bacalao seco y ahumado de alta calidad para sus recetas tradicionales.',
          longDescription: 'Ofrecemos una variedad de Bacalao secos y ahumados, preparados siguiendo métodos tradicionales. Son perfectos para añadir sabor umami a sopas, guisos y salsas africanas.',
          origin: 'Costa de Marfil',
          category: 'Pescados',
        },
      },
