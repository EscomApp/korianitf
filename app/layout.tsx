...
export const metadata: Metadata = {
  ...
  description: 'Empresa especializada en la importación y exportación de productos alimenticios (vivriers). Especialistas en attieke y productos africanos de alta calidad.',
